...
def complex_matrix(q):
    '''
Factory function returning the matrix representation of a quaternion as a NumPy array.  The function returns a matrix with complex numbers as elements.
        
The addition and multiplication of the matrices correspond to the addition and multiplication of the quaternions.
    '''
...
def real_matrix(q):
    '''
Factory function returning the matrix representation of a quaternion as a NumPy array.  The function returns a matrix with real numbers as elements.
...
The addition and multiplication of the quaternons correspond to the addition and multiplication of the matrices.
    '''
    ...
    if a.dtype.name[:7] == 'complex':
        ...
        #if c01.real != -c10.real or c01.imag != c10.imag or c00.conjugate() != c11:
            #raise ValueError('Matrix cannot be converted to quaternion')
