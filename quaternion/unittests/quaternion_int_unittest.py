...
class QuaternionicIntegerTestCase(unittest.TestCase):
    ...
    def test_instantiation(self):
        ...
        self.assertEqual(QuaternionicInteger(j=3, scalar=-2, k=10), QuaternionicInteger(-2, 0, 3, 10))
        self.assertEqual(QuaternionicInteger(j=3, scalar=-2, k=10, i=-6), QuaternionicInteger(-2, -6, 3, 10))
        self.assertEqual(QuaternionicInteger(-2, j=3, k = 10, i=-6), QuaternionicInteger(-2, -6, 3, 10))
        self.assertEqual(QuaternionicInteger(-2, -6, j=3, k=10), QuaternionicInteger(-2, -6, 3, 10))
        self.assertEqual(QuaternionicInteger(-2, -6, 3, k=10), QuaternionicInteger(-2, -6, 3, 10))
        ...
        self.assertEqual(QuaternionicInteger(self.c), QuaternionicInteger(self.c.real, self.c.imag, 0, 0))
        ...
        with self.assertRaises(TypeError):
            q = QuaternionicInteger(1, 1, 1, 1, 1)
        with self.assertRaises(TypeError):
            q = QuaternionicInteger(1, 3+2j)
        with self.assertRaises(TypeError):
            q = QuaternionicInteger(3+2j, self.q)
        with self.assertRaises(TypeError):
            q = QuaternionicInteger(3+2j, -4-6j, 1)
        with self.assertRaises(TypeError):
            q = QuaternionicInteger(self.q, 5)
        with self.assertRaises(ValueError):
            q = QuaternionicInteger('x')
        with self.assertRaises(TypeError):
            q = QuaternionicInteger(4+3j, k=7)
        with self.assertRaises(TypeError):
            q = QuaternionicInteger(scalar=4+3j)
        with self.assertRaises(TypeError):
            q = QuaternionicInteger(9, scalar=4)
        with self.assertRaises(TypeError):
            q = QuaternionicInteger(9, -4, i=-7)
        with self.assertRaises(TypeError):
            q = QuaternionicInteger(9, -4, -7, j=0)
        with self.assertRaises(ValueError):
            q = QuaternionicInteger(x=7)
    ...
    def test_addition(self):
        ...
        self.assertQEqual(self.iq1 + self.f, Quaternion(2.6, 9, -10, 4))
        self.assertIsInstance(self.f + self.iq1, Quaternion)
        self.assertNotIsInstance(self.f + self.iq1, QuaternionicInteger)
        self.assertQEqual(self.f + self.iq1, Quaternion(2.6, 9, -10, 4))
    ...
    def test_subtraction(self):
        ...
        self.assertIsInstance(self.iq1 - self.q, Quaternion)
        self.assertNotIsInstance(self.iq1 - self.q, QuaternionicInteger)
        self.assertQEqual(self.iq1 - self.q, Quaternion(1.3, -8.1, -7.6, -0.8))
        self.assertIsInstance(self.q - self.iq1, Quaternion)
        self.assertNotIsInstance(self.q - self.iq1, QuaternionicInteger)
        self.assertQEqual(self.q - self.iq1, Quaternion(-1.3, 8.1, 7.6, 0.8))
        
        #subtraction between a quaternionic integer and a complex number
        self.assertIsInstance(self.iq1 - self.c, Quaternion)
        self.assertQEqual(self.iq1 - self.c, Quaternion(-5, 14, -10, 4))
        self.assertIsInstance(self.c - self.iq1, Quaternion)
        self.assertQEqual(self.c - self.iq1, Quaternion(5, -14, 10, -4))
        ...
        self.assertIsInstance(self.iq1 - self.f, Quaternion)
        self.assertNotIsInstance(self.iq1 - self.f, QuaternionicInteger)
        self.assertQEqual(self.iq1 - self.f, Quaternion(7.4, 9, -10, 4))
        self.assertIsInstance(self.f - self.iq1, Quaternion)
        self.assertNotIsInstance(self.f - self.iq1, QuaternionicInteger)
        self.assertQEqual(self.f - self.iq1, Quaternion(-7.4, -9, 10, -4))
    ...
    def test_multiplication(self):
        ...
        self.assertIsInstance(self.iq1 * self.q, Quaternion)
        self.assertNotIsInstance(self.iq1 * self.q, QuaternionicInteger)
        self.assertQEqual(self.iq1 * self.q, Quaternion(-178.6, 80.4, -23.8, 188.2))
        ...
        self.assertIsInstance(self.q * self.iq1, Quaternion)
        self.assertNotIsInstance(self.q * self.iq1, QuaternionicInteger)
        self.assertQEqual(self.q * self.iq1, Quaternion(-178.6, 157.2, -74.2, -110.6))
        
        #multiplication between a quaternionic integer and a complex number
        self.assertIsInstance(self.iq1 * self.c, Quaternion)
        self.assertQEqual(self.iq1 * self.c, Quaternion(95, 65, -120, -10))
        self.assertIsInstance(self.c * self.iq1, Quaternion)
        self.assertQEqual(self.c * self.iq1, Quaternion(95, 65, -80, 90))
        ...
        self.assertIsInstance(self.iq1 * self.f, Quaternion)
        self.assertQEqual(self.iq1 * self.f, Quaternion(-12, -21.6, 24, -9.6))
        self.assertIsInstance(self.f * self.iq1, Quaternion)
        self.assertQEqual(self.f * self.iq1, Quaternion(-12, -21.6, 24, -9.6))
    ...
    def test_division(self):
        ...
        self.assertQEqual(self.iq3 / self.iq4, Quaternion(3))
    ...
    def test_conjugate(self):
        ...
        self.assertEqual(self.iq1.conjugate(), QuaternionicInteger(self.iq1.scalar, -self.iq1.i, -self.iq1.j, -self.iq1.k))

    def test_conversion(self):
        self.assertQEqual(Quaternion(QuaternionicInteger(5.3, 9.2, -10.8, 4.6)), Quaternion(5, 9, -10, 4))
    ...
    def test_power(self):
        ...
        self.assertQEqual(self.iq1 ** 2, self.iq1 * self.iq1)
        self.assertQEqual(self.iq1 ** -1, self.iq1.reciprocal())
        self.assertQEqual(self.iq1 ** -1, 1 / self.iq1)
    ...
    def test_norm(self):
        ...
        self.assertAlmostEqual(self.iq1.norm()**2, self.iq1.scalar**2+self.iq1.i**2+self.iq1.j**2+self.iq1.k**2)
    
    def test_reciprocal(self):
        self.assertQEqual(self.iq1 * self.iq1.reciprocal(), QuaternionicInteger(1))
        self.assertQEqual(self.iq1.reciprocal() * self.iq1, QuaternionicInteger(1))
    
    def test_unit(self):
        self.assertQEqual(self.iq1.norm() * self.iq1.unit(), self.iq1)
    ...
    def test_hash(self):
        self.assertEqual(hash(self.iq1), hash((self.iq1.scalar, self.iq1.i, self.iq1.j, self.iq1.k)))
